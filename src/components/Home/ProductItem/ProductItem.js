...
function ProductItem(props) {
    ...
    const showProduct = () => {
        let result = List.map((task, index) => {
            return <Link href={`/product/${to_slug(task.name)}?${task.id}`} as={`/product/${to_slug(task.name)}?${task.id}`} key={index}>
...
//     const showProduct = () => {
//             let result = List.map((task, index) => {
//                 return <Link href="/descproducts" as="/chi-tiet" key={index}>
//                     <Col lg={3} md={3} sm={3} className="resp">
//                         <div className="image-box is-trending has-discount">
//                             <div className="thumb">
//                                 <div className="background-image" style={{ backgroundImage: `url(${task.images[1]})` }}>

//                                 </div>
//                                 <div className="background-image thumb-img-first secondary-image" style={{ backgroundImage: `url(${task.images[0]})` }}>
//                                 </div>
//                             </div>
//                             <div className="meta-inner">
